    ...
    <div className={cx("SignUp")}>
      ...
      <div className={cx("Form")}>
        <div className={cx("Item")}>
          ...
          <input className={cx("Input")} name="email" type="email" placeholder="이메일" onChange={onChange} value={inputs.email} required />
        </div>
        <div className={cx("Item")}>
          <span className={cx("Text")}>비밀번호</span>
          <input className={cx("Input")} name="password1" type="password" placeholder="비밀번호" onChange={onChange} value={inputs.password1} required />
        </div>
        <div className={cx("Item")}>
          <span className={cx("Text")}>비밀번호 확인</span>
          <input className={cx("Input")} name="password2" type="password" placeholder="비밀번호 확인" onChange={onChange} value={inputs.password2} required />
        </div>
      </div>
